...
本文面向项目所有者、发布操作员和事故响应人员。它描述当前生产架构、自动更新、监控、Secret、部署、回滚和故障处理。发布前还必须逐项完成 [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md)。
...
9. 完成 [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md) 的部署后验收并保存结果。
...
- 临时测试浏览器、截图、日志、下载包和本地审计工具放在 ignored `artifacts/`，不得提交。
